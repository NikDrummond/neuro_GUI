...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        # Side panel: file info and selection toggle
        ...
        self.filename_label.setStyleSheet("font-weight: bold;")  # bold text
        side_layout.addWidget(self.filename_label)
        # Selection toggle
        self.select_toggle = QAction("Select Points", self)
        # Since QAction cannot display as widget, use a QPushButton toggle
    ...
    # ------------------- Point Selection -------------------
    def toggle_select_points(self, enabled):
        interactor = self.vtkWidget.GetRenderWindow().GetInteractor()
        if enabled:

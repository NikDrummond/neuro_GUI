...
class MainWindow(QMainWindow):
    ...
    def toggle_select_points(self, on):
        ...
        if on:
            ...
            # Catch double‐clicks instead of single clicks
            self.vtkWidget.installEventFilter(self)
        else:
            # Exit selection mode
    ...
    def eventFilter(self, obj, event):
        # Intercept double‐clicks on the VTK widget
        if obj is self.vtkWidget and event.type() == QEvent.MouseButtonDblClick:

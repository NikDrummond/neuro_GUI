...
class MainWindow(QMainWindow):
    ...
    def set_reroot(self):
        idx = get_mask_node_ind(self.current_neuron, self.pnt_mask)[0]
        nr.reroot_neuron(self.current_neuron, root = idx, inplace = True, prune = False)
        # QMessageBox.information(self, 'Reroot Neuron', f'Would reroot to node {idx}')
    # Will implement actual reroot logic similar to mask_downstream in the future
